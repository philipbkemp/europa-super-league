...
clubPages = ["not-a-real-club"
	...
	/*dnk*/	,"brondby_if","akademisk_boldklub","kjobenhavns_boldklub","boldklubben_frem","fc_copenhagen","fc_midtjylland"
	...
	/*mkd*/,"kf_shkendija"
	/*mlt*/	,"floriana_fc","sliema_wanderers_fc","valletta_fc","hibernians_fc","hamrun_spartans_fc"
	/*mne*/,"fk_buducnost_podgorica"
	/*nir*/	,"linfield_fc","cliftonville_fc"
...
$(document).ready(function(){
	$('[data-bs-toggle="tooltip"]').tooltip({
		container: '#divisionsTables, #winnersTables, #historyTables, .club-list, .country-list, .flag-list',
		html: true
	});
});
